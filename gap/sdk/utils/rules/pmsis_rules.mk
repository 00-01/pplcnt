...
ifdef CONFIG_SLOW_OSC
    ...
    # when need slow ref clock, activate it after wakeup from rom otherwise it will shut it down which will disturbs RTC
...
ifeq '$(include_fs_targets)' '1'
    ...
    #include $(GAP_SDK_HOME)/tools/gapy/rules/readfs.mk    # ReadFS
    include $(GAP_SDK_HOME)/utils/gapy/rules/littlefs.mk    #Littlefs
    include $(GAP_SDK_HOME)/utils/gapy/rules/flash.mk    # Flash tools
endif
